...
//             fetchDataFromServer(`https://api.themoviedb.org/3/
//             search/movie?api_key=${api_key}&query=${searchField.value}
//             &page=1&include_adult=false`, function( {
//             results: movielist})  {
...
//                     searchResultModel.querySelector(".grid-list").
